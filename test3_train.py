...
from test3_test import test
from utils.dataset import UCFDataset
from utils.tools_test3 import get_prompt_text, get_batch_label
import test3_option
from torch.utils.tensorboard import SummaryWriter

writer = SummaryWriter(log_dir='logs/test3')
...
def CLASM(logits, labels, lengths, device):
    ...
    for i in range(logits.shape[0]):
        # print(f'leangth shape is {lengths[i].shape}')
